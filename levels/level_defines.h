...
DEFINE_LEVEL("MAIN MAP", LEVEL_CASTLE_GROUNDS, COURSE_NONE, castle_grounds, outside, 20000, 0x80, 0x80, 0xB0, _, sCamCastleGrounds) 
...
DEFINE_LEVEL("URANIWA", LEVEL_CASTLE_COURTYARD, COURSE_NONE, castle_courtyard, outside, 20000, 0xA0, 0x00, 0x00, _, sCamCastleCourtyard) 
