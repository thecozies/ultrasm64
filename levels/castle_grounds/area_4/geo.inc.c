...
const GeoLayout castle_grounds_area_4_geo[] = {
	GEO_NODE_START(),
	GEO_OPEN_NODE(),
		GEO_TRANSLATE_NODE(LAYER_OPAQUE, 2500, -4300, 2800),
		GEO_OPEN_NODE(),
		...
		GEO_OPEN_NODE(),
			...
			GEO_CLOSE_NODE(),
		GEO_CLOSE_NODE(),
		GEO_TRANSLATE_NODE(LAYER_OPAQUE, 2200, -4300, 4700),
		GEO_OPEN_NODE(),
			GEO_RENDER_RANGE(-1500, 1500),
			GEO_OPEN_NODE(),
				GEO_DISPLAY_LIST(6, castle_grounds_dl_vines_002_mesh_layer_6),
			GEO_CLOSE_NODE(),
		GEO_CLOSE_NODE(),
	GEO_CLOSE_NODE(),
	GEO_RETURN(),
