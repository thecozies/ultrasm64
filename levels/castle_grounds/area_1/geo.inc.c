...
const GeoLayout castle_grounds_area_1_geo[] = {
	...
	GEO_OPEN_NODE(),
		...
		GEO_DISPLAY_LIST(LAYER_OPAQUE, castle_grounds_dl_a_ROOM_no_col_mesh),
		GEO_DISPLAY_LIST(1, castle_grounds_dl_a_ROOM_no_col_mesh_layer_1),
		GEO_DISPLAY_LIST(5, castle_grounds_dl_Plane_mesh_layer_5),
	GEO_CLOSE_NODE(),
	GEO_RETURN(),
};
