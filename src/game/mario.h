...
enum CUTSCENE_INTRO_ACTS {
    ...
    CUTSCENE_INTRO_DOOR_FOLLOW_ORB = 501,
    CUTSCENE_INTRO_LUCY_LOOKS_OVER = 630,
    CUTSCENE_INTRO_LUCY_WALKS_OVER = 661,
    CUTSCENE_INTRO_END = 750
};
