...
char sTitleGame[] = "Modeling | Programming";
...
char sTestersText[] = "rocky | fordescort\nReonu\nThe Sour OG";

char sTitleSpecial[] = "Special thanks to...";
char sMessageSimple[] =  "Simpleflips - for expanding the SM64\nhacking community.";
char sMessageSimple2[] = "From players to modders, we couldn't\nhave gone this far without you.";
...
#define C_SUSTAIN_XLONG 150
#define C_SUSTAIN_LONG 100
#define C_SUSTAIN 60
#define C_SUSTAIN_SHORT 45
#define C_SUSTAIN_VERY_SHORT 30
...
#define TITLE_MID_L ((SCREEN_HEIGHT / 2))

#define MESSAGE_OFFSET 0
#define MESSAGE_H 110
#define MESSAGE_H_2 130
#define MESSAGE_H_3 150
#define MESSAGE_H_4 170
...
#define print_message_lower(s)  (s2d_print_deferred((CENTER_W + MESSAGE_OFFSET), MESSAGE_H_3,  ALIGN_CENTER, sCreditMessageState.fadeAlpha, MESSAGE_SIZE, s))
...
void print_titles(void) {
    ...
    s32 done = handle_fade(C_ATTACK, sCreditTitleState.section == CREDITS_GAME_TITLE ? C_SUSTAIN_XLONG : 0, C_RELEASE, &sCreditTitleState);
    if (done) next_title();
        ...
        case CREDITS_SPECIAL:
            if (sCreditMessageState.section == 0) {
                if (holdForFollowup) {
                    ...
                    print_message_lower(sMessageSimple2);
