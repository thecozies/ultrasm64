...
#define SOUND_LUCY_SEES_ORB           /* 0x2439FF80 */ SOUND_ARG_LOAD(SOUND_BANK_VOICE,    0x39, 0xFF, SOUND_NO_PRIORITY_LOSS | SOUND_DISCRETE)
#define SOUND_LUCY_DOOR_SHUTS                /* 0x243AFF80 */ SOUND_ARG_LOAD(SOUND_BANK_VOICE,    0x3A, 0xFF, SOUND_NO_PRIORITY_LOSS | SOUND_DISCRETE)
#define SOUND_LUCY_FINAL_WOAH              /* 0x243BFF80 */ SOUND_ARG_LOAD(SOUND_BANK_VOICE,    0x3B, 0xFF, SOUND_NO_PRIORITY_LOSS | SOUND_DISCRETE)
...
#define SOUND_0E_ORB_WUB_CUSTOM                                   SOUND_ARG_LOAD(SOUND_BANK_GENERAL,  0x80, 0x80, 0 | SOUND_CONSTANT_FREQUENCY | SOUND_NO_ECHO | SOUND_LOWER_BACKGROUND_MUSIC)
