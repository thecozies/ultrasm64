...
#define ACT_SLOW_WARP                  (0x13E | ACT_FLAG_STATIONARY | ACT_FLAG_INTANGIBLE)
#define ACT_TEMPLE_1_INTRO             (0x13F | ACT_FLAG_STATIONARY | ACT_FLAG_INTANGIBLE)
#define ACT_CAMP_INTRO                 (0x13F | ACT_FLAG_STATIONARY | ACT_FLAG_INTANGIBLE | ACT_FLAG_INVULNERABLE)
#define ACT_ORB_REVEAL                 (0x10B | ACT_FLAG_STATIONARY | ACT_FLAG_INTANGIBLE)
#define ACT_LUCYS_LEVITATION           (0x10C | ACT_FLAG_STATIONARY | ACT_FLAG_INTANGIBLE)
